...
class GetTaxonomy(AuthenticatedMethod):
    ...
    Returns: :class:`WordPressTaxonomy` wc_instance.
    """
...
class GetTerm(AuthenticatedMethod):
    ...
    Returns: :class:`WordPressTerm` wc_instance.
    """
...
class NewTerm(AuthenticatedMethod):
    ...
    Parameters:
        `term`: wc_instance of :class:`WordPressTerm`
...
class EditTerm(AuthenticatedMethod):
    ...
    Parameters:
        ...
        `term`: A :class:`WordPressTerm` wc_instance with the new values for the term.
