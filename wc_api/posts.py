...
class GetPost(AuthenticatedMethod):
    ...
    Returns: :class:`WordPressPost` wc_instance.
    """
...
class NewPost(AuthenticatedMethod):
    ...
    Parameters:
        `content`: A :class:`WordPressPost` wc_instance with at least the `title` and `content` values set.
...
class EditPost(AuthenticatedMethod):
    ...
    Parameters:
        ...
        `content`: A :class:`WordPressPost` wc_instance with the new values for the blog post.
...
class GetPostType(AuthenticatedMethod):
    ...
    Returns: :class:`WordPressPostType` wc_instance.
    """
