...
class GetUser(AuthenticatedMethod):
    ...
    Returns: :class:`WordPressUser` wc_instance.
    """
...
class GetProfile(AuthenticatedMethod):
    ...
    Returns: wc_instance of :class:`WordPressUser` representing the user whose credentials are being used with the XML-RPC API.
    """
...
class EditProfile(AuthenticatedMethod):
    ...
    Parameters:
        `user`: `WordPressUser` wc_instance.
